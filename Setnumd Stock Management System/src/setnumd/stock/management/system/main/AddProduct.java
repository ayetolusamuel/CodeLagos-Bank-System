...
//
//    private void fieldValueByDefault() {
//        txtPName.setEnabled(false);
//        txtJumiaOrderNumber.setEnabled(false);
//        txtDespatchName.setEnabled(false);
//        txtPCategory.setEnabled(false);
//        txtPDescription.setEnabled(false);
//        txtPPrice.setEnabled(false);
//        txtQuantity.setEnabled(false);
//        txtRemark.setEnabled(false);
//        jcmbPAccount.setEnabled(false);
//        jcmbPayment.setEnabled(false);
//        jcmbPlatform.setEnabled(false);
//        
//        lblPName.setEnabled(false);
//        lblpPrice.setEnabled(false);
//        lblPCategory.setEnabled(false);
...
//    private boolean isTextFieldEmpty() {
//        boolean flag = true;
//        String code = txtPCode.getText();
//       
//        String price = txtPPrice.getText();
//       
//        String cat = txtPCategory.getText();
//
//        String checkCode = code.substring(0, 3);
//
//        if (code.length() == 0 || name.length() == 0 || description.length() == 0 || price.length() == 0 || cat.length() == 0 || checkCode.equals("Set")) {
//            return flag;
//        }
//
//        return false;
...
//    public static void main(String[] args) {
//
//        DailyStockView dailyStock = new DailyStockView();
//        dailyStock.setVisible(true);
//        dailyStock.setLocation(300, 100);
//        dailyStock.setSize(550, 520);
//        dailyStock.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//    }